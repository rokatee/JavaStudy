...
○ 개요
	...
	이러한 클래스나 인터페이스의 묶음을 패키지(pakage)라고 한다
...
public class Test126 // extends Object
{
	...
	*/
	...
	toString() // 우리 눈엔 보이지 않지만 상속받은 Object 내에
	{		   // toString() 메소드가 있을 것이다
		...;
	}
	...
	*/
	...
	public static void main(String[] args)
	{
		...
		System.out.println(ob.toString());	// toString() 메소드가 없음에도 에러가 안나는 이유?
		// → Test126@15db9742				// 65번 줄 참고

		// → 메모리 주소가 아니라
		//	  자바가 객체를 구분하기 위해 임의로 부여하는 식별번호
		//	  Test126 클래스에 toString() 메소드가
		//    존재하지 않음에도 불구하고 에러가 발생되지 않는 상황
		//	  → Object 로 부터 상속받음
