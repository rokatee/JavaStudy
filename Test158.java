...
○ Vector(벡터)
	...
	- E remove(int index)
	  ...
	  E remove(int index) 메소드는 저장되어던 객체를 반환한다

	- boolean removeElements(Object obj)
...
public class Test158
{
	...
	public static void main(String[] args)
	{
		...
		// ※ line 127 데이터 추가 후
		// → 마지막 요소 : 하양
		//    (중간에 하양 요소를 추가해서(127번 줄) 마지막 요소가 연두 → 하양 으로 바뀜)

		// ※ 벡터 자료구조에 요소 추가 시(→ add() / addElement())
		//	  인덱스 마지막(가장 끝)에 위치에 추가되는 것을 확인할 수 있다
		...
		while (it.hasNext())				// 1. true  3. true  5. true  7. true   9. true  11. true  13. false 
		{									//     ↓		↓		 ↓		  ↓		↓		  ↓ ↗	(연두까지 뽑으면
			str = (String)it.next();		// 2. 검정  4. 노랑  6. 초록  8. 파랑  10. 빨강  12. 연두	 남은 값이 없으므로)
